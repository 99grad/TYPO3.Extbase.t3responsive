...
class tx_t3responsive_pi1 extends tslib_pibase {

	var $prefixId = 'tx_t3responsive_pi1';
	var $scriptRelPath = 'pi1/class.tx_t3responsive_pi1.php';
	var $extKey = 't3responsive';
	...
	function main($content,$conf) {
		...
		return "tx_t3responsive_pi1 meldet: Kein view für {$this->ffData['field_option']} gefunden. Einstellung im flexform prüfen!";
	}
...
################################################################################################################################################################################################
	...
	function getElementCountClasses ( $content, $conf ) {
		...
		if (!$GLOBALS['__tx_t3responsive_pi1']) $GLOBALS['__tx_t3responsive_pi1'] = array();
		$arr = $GLOBALS['__tx_t3responsive_pi1'];
		...
		$GLOBALS['__tx_t3responsive_pi1'] = $arr;		
		if (!$found) return '';
...
################################################################################################################################################################################################
	...
	function get_dropdown_navi ( $content, $conf ) {
		...
		if (!$pid) return 'tx_t3responsive_pi1->get_dropdown_navi() :: Keine pid übergeben. TS-Setup prüfen.';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3responsive/pi1/class.tx_t3responsive_pi1.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3responsive/pi1/class.tx_t3responsive_pi1.php']);
}
